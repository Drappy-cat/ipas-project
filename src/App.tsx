...
export default function App() {
  ...
  const getBabProgress = (babId: number, hasInteractive: boolean) => {
    ...
    let score = 0;
    if (completed.includes('materi')) score += 50;
    if (hasInteractive && completed.includes('interaktif')) score += 50;
    else if (!hasInteractive) score += 50; // if no interactive, reading is 100%
    return score;
  };
